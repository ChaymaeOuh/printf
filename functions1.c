	...
	int flags, int width, int precision, int size)
{
	...
	return (my_write_unsgnd(0, i, buffer, flags, width,
				precision, size));
}
...
/**
 * my_print_hexadecimal - Prints an unsigned number in hexadecimal
...
/**
 * my_print_hexa_upper - Prints an unsigned number in upper hexadecimal
 * @types: Liste of arguments
 * @buffer: Buffer array to handle print
 * @flags: Calculates active flags
 * @width: get width
...
/**
 * my_print_hexa - Prints a hexadecimal number in lower or upper
 * @types: Liste of arguments
	...
	int flags, char flag_ch, int width, int precision, int size)
{
	...
	return (my_write_unsgnd(0, i, buffer, flags, width, precision,
				size));
}
