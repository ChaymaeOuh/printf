	...
	int flags, int width, int precision, int size)
{
	...
	return (my_write_pointer(buffer, ind, length,
		width, flags, padd, extra_c, padd_start));
}


/**
 * my_print_non_printable - Prints ascii codes in hexa of nn print chars
...
/**
 * my_print_reverse - Prints reverse string.
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags: Calculates active flags
 * @width: get width
...
/**
 * my_print_rot13string - Print a string in rot13.
 * @types: Lista of arguments
 * @buffer: Buffer array to handle print
 * @flags: Calculates active flags
 * @width: get width
